...
# copy dlls, exes and such needed to run LifeStream from within 
# VisualStudio. 
...
if(EXISTS ${debug_msvc8_redist_path})
    ...
    add_custom_command(
        ...
        ARGS
          ...
          ${CMAKE_CURRENT_SOURCE_DIR}/LifeStreamDebug.exe.config
...
if(EXISTS ${release_msvc8_redist_path})
    ...
    add_custom_command(
        ...
        ARGS
          ...
          ${CMAKE_CURRENT_SOURCE_DIR}/LifeStream.exe.config
